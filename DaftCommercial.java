...
public class DaftCommercial {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		By commercial_btn=By.xpath("//a[contains(text(),'Commercial')]");
		...
		Thread.sleep(3000);
		driver.findElement(commercial_btn).click();
		Thread.sleep(3000);
		
		filters(driver,"Dublin 24");
...
//			driver.findElement(msg_loc).sendKeys("Hello , Me and my fiancé are looking for a permanent accommodation. " + '\n' + " We came across your advertisement and we are very much interested in renting it. " + '\n' + " We both are full time working professionals earning more than 70000+ euros yearly and can provide pay slips and references. " + '\n' + " We are clean, peaceful, vegetarian, non party and non smokers." + '\n' + " We don’t have pets with us. " + '\n' + " We maintain the cleanliness standard of the house. " + '\n' + " I would like to know if there is any possibility that we can have a viewing. " + '\n' + " We can move in immediately as well.  " + '\n' + " Thank you," + '\n' + " xyz");
	...
	public static boolean filters(WebDriver driver,String location){
		try{
			By share_loc=By.xpath("//li[contains(text(),'Rent')]");
			By enter_loc=By.xpath("//input[contains(@id,'search-box-input')]");
			By search2_btn=By.xpath("//div[contains(@class,'SearchPageFilters__LocationWrapper-sc-6j391p-4 fYmqXl')]");
			By list_loc=By.xpath("//ul[contains(@data-testid,'re')]//li[2]");
			...
			By type_btn=By.xpath("//button[contains(text(),'Type')]");
			By reston_btn=By.xpath("//li[contains(@data-testid,'multi-select-list-item-restaurants-bars-hotels')]");
			By retail_btn=By.xpath("//li[contains(@data-testid,'multi-select-list-item-retail-units')]");
			By comm=By.xpath("//h1[contains(text(),'Comm')]");
			...
			driver.findElement(enter_loc).sendKeys(Keys.RETURN);
			Thread.sleep(3000);
			driver.findElement(search2_btn).click();
			Thread.sleep(3000);
			driver.findElement(price_btn).click();
			Thread.sleep(3000);
			driver.findElement(type_btn).click();
			Thread.sleep(3000);
			driver.findElement(reston_btn).click();
			Thread.sleep(3000);
			driver.findElement(retail_btn).click();
			Thread.sleep(1000);
			driver.findElement(comm).click();
